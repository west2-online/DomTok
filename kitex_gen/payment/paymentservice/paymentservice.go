...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"RequestRefundToken": kitex.NewMethodInfo(
		requestRefundTokenHandler,
		newPaymentServiceRequestRefundTokenArgs,
		newPaymentServiceRequestRefundTokenResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func requestRefundTokenHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*payment.PaymentServiceRequestRefundTokenArgs)
	realResult := result.(*payment.PaymentServiceRequestRefundTokenResult)
	success, err := handler.(payment.PaymentService).RequestRefundToken(ctx, realArg.Request)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newPaymentServiceRequestRefundTokenArgs() interface{} {
	return payment.NewPaymentServiceRequestRefundTokenArgs()
}

func newPaymentServiceRequestRefundTokenResult() interface{} {
	return payment.NewPaymentServiceRequestRefundTokenResult()
}
...
func (p *kClient) RequestRefundToken(ctx context.Context, request *payment.RefundTokenRequest) (r *payment.RefundTokenResponse, err error) {
	var _args payment.PaymentServiceRequestRefundTokenArgs
	_args.Request = request
	var _result payment.PaymentServiceRequestRefundTokenResult
	if err = p.c.Call(ctx, "RequestRefundToken", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
