...
type Client interface {
	...
	ListAddress(ctx context.Context, req *user.ListAddressRequest, callOptions ...callopt.Option) (r *user.ListAddressResponse, err error)
	DeleteAddress(ctx context.Context, req *user.DeleteAddressRequest, callOptions ...callopt.Option) (r *user.DeleteAddressResponse, err error)
...
func (p *kUserServiceClient) ListAddress(ctx context.Context, req *user.ListAddressRequest, callOptions ...callopt.Option) (r *user.ListAddressResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ListAddress(ctx, req)
}

func (p *kUserServiceClient) DeleteAddress(ctx context.Context, req *user.DeleteAddressRequest, callOptions ...callopt.Option) (r *user.DeleteAddressResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
