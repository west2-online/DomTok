...
type UserInfo struct {
	...
	Role   int64  `thrift:"role,3" form:"role" json:"role" query:"role"`
}
...
func (p *UserInfo) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("role", thrift.I64, 3); err != nil {
		goto WriteFieldBeginError
	}
...
type Sku struct {
	...
	SaleAttr         []*AttrValue `thrift:"saleAttr,13,optional,list<AttrValue>" form:"saleAttr" json:"saleAttr,omitempty" query:"saleAttr"`
...
type OrderWithGoods struct {
	...
	Goods []*OrderGoods `thrift:"goods,2,required,list<OrderGoods>" form:"goods,required" json:"goods,required" query:"goods,required"`
}
...
type BaseOrderWithGoods struct {
	...
	Goods []*BaseOrderGoods `thrift:"goods,2,required,list<BaseOrderGoods>" form:"goods,required" json:"goods,required" query:"goods,required"`
}
