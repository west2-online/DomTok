...
func DeleteCategory(ctx context.Context, c *app.RequestContext) {
	...
	base, err := rpc.DeleteCategoryRPC(ctx, &commodity.DeleteCategoryReq{
...
func ViewCategory(ctx context.Context, c *app.RequestContext) {
	...
	info, err := rpc.ViewCategoryRPC(ctx, &commodity.ViewCategoryReq{
		PageNum:  req.PageNum,
...
func UpdateCategory(ctx context.Context, c *app.RequestContext) {
	...
	base, err := rpc.UpdateCategoryRPC(ctx, &commodity.UpdateCategoryReq{
		CategoryID: req.CategoryID,
		Name:       req.Name,
	})
	if err != nil {
